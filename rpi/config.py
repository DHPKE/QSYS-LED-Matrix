...
LAYOUT_PRESETS = {
    ...
    # NO GAP - segments touch curtain directly at pixel 2
    8: [(2,        2,         48,    28   ),                            # segment 0: large left (48×28, touches curtain)
    ...
    9: [(0,        0,         1,     1    ),                            # segment 0 hidden
        (32,       2,         30,    28   ),                            # segment 1: half display (30×28, touches curtain)
