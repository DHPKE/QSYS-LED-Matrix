...
Uses the built-in http.server so there are zero extra dependencies.

Run with sudo (or set cap_net_bind_service) for port 80, or change
WEB_PORT to 8080 in config.py for unprivileged access.

(Identical logic to rpi/web_server.py — subtitle updated for Rock Pi S.)
"""
...
<div class="container">
  <div class="header">
    ...
    <div class="subtitle">RADXA Rock Pi S — Built-in Ethernet — 64×32 RGB Display</div>
  </div>
